...
btn_equal= tk.Button(root, text="=", command=evaluate_calculation ,width=12, font=('Arial', 14)) # width=5 for decimal symbol
btn_equal.grid(row=6,column=3,columnspan=2) #columnspawn-3 for decimal symbol
#btn_dec= tk.Button(root, text=".", command=lambda:add_to_calculations("."),width=5, font=('Arial', 14))
#btn_dec.grid(row=6,column=4,columnspan=3)
root.mainloop()